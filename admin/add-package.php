          ...
          <div class="tile">
            ...
            <form class="row" method="post">
              ...
              <div class="form-group col-md-12">
                ...
                <input class="form-control" name="addPackage" id="addPackage" type="text" placeholder="Add Package Type">
              </div>
                ...
                ?>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <a href="edit-package.php?cid=<?php echo htmlentities($result->id); ?>"><button class="btn btn-primary" type="button">Edit</button></a>
                          <a onclick="return confirm('Do you want to delete this record ?')" href="add-package.php?del=<?php echo htmlentities($result->id); ?>"><button class="btn btn-danger" type="button">Delete</button></a>
                        </td>
                      </tr>
                  <?php $cnt = $cnt + 1;
                  }
