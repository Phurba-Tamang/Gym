...
if (strlen($_SESSION['adminid'] == 0)) {
  ...
  if (isset($_POST['Submit'])) {
    ...
    } else if (!is_numeric($Price) && (!is_integer($Price) || !is_float($Price))) {
      $errormsg = "Enter valid price !";
    } else {
      $sql = "INSERT INTO tbladdpackage (category,titlename,PackageType,PackageDuratiobn,Price,uploadphoto,Description) Values(:category,:titlename,:package,:packageduratiobn,:Price,:photo,:description)";
